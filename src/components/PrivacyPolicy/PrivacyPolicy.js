  ...
  render() {
    return (
      <ScrollView style={styles.scrollView}>
        <Text style={styles.text}>{thePolicy}</Text>
      </ScrollView>
    );
  }
}
